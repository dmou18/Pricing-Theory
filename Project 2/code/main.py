...
if __name__ == "__main__": 
    ...
    # Analysis.HistPL(portfolio - putOption[:,-1], 'P&L Distribution for Time-based Delta-Gamma Hedging')
    ...
    # Analysis.HistPL(lazyPortfolio - lazyPutOption[:,-1], 'P&L Distribution for Move-based Delta-Gamma Hedging')
